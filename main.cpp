...
void loop() {
    ...
    if (chargingInProgress && currentTime - lastChangeTime > chargeLevelChangeInterval - 1000) {
...
// Reseteaza toate LED-urile de incarcare
void resetChargingLEDs() {
...
// Functia care porneste procesul de incarcare
void startCharging() {
...
// Functia care opreste fortat procesul de incarcare
void stopCharging() {
...
// Functia care finalizeaza incarcarea normal
void completeCharging() {
    chargingInProgress = false;
    stationAvailable = true;
    currentChargeLevel = 0;
